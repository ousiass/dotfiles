---
name: doc-drift-git
description: git リモートとの差分を対象にドキュメントと実装コードの整合性をチェックし、乖離レポートを生成する。PR 作成前にドキュメントの更新漏れがないか確認したい、ブランチでの変更とドキュメント記述のズレを洗い出したいときに使う。
---
