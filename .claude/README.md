...
| `/refine-sweep` | 全コードベースに対して 4 観点 review→fix→PR→merge を反復し critical+major=0 まで持っていく。仕様書のドメイン軸（frontend/backend/db/ci 等）でステージ分割し、ドメインごとに別 PR を並列で develop にマージ |
